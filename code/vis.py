...
def create_kmeans_overlay(sat,country,cluster,bounds):
    ...
    image= os.path.join("../analysis",country,"kmeans_analysis",sat,str(cluster),f"cluster_img_{cluster}.png")
    try :
...
def vis(country):
    ...
    with rasterio.open(raster_path) as dataset:
        ...
        # Convertir les coordonnées du pixel central en coordonnées géographiques
    ...
    # Créer la carte Folium centrée sur le centre du raster
    ...
    # Ajouter des marqueurs aux coins de l'image raster
